...
const Riskslider = () => {
  const features = [
    ...
    },
    {
      ...
      icon: <img src={rmsicon3} alt="Stress Test Icon" className="w-10 h-10" />,
    },
    {
